...
const FAQ: [string, string][] = [
  ...
  ["Does the AI assistant send my data to third parties?", "Only if you choose to connect one, either OpenAI or DeepSeek. Leave OPENAI_API_KEY blank during installation and the assistant is disabled. Nothing is sent anywhere, and no other part of the product changes."],
  ...
  ["What happens if I lose PURVEX_ENCRYPTION_KEY?", "Everything it protects, including SIEM credentials and source tokens, becomes permanently unreadable. There is no way to recover it other than restoring the original key, so back it up before connecting any real credentials."],
];
