  ...
  return (
    <>
      ...
      <P>Three tabs: <strong>Review</strong> (the default queue, sorted into Telemetry missing, Needs tuning,
        ...
        (pending changes waiting on approval &mdash; more below).</P>
      <P>
      ...
      <P>
        ...
        silently overwrite it &mdash; it opens a proposal instead (see below).
      </P>
      ...
      <P>
        ...
        auto-committed there &mdash; a running, human-readable record of what your SIEM&apos;s detections looked
        like over time. A mirror never reads the repo back.
      </P>
      ...
      <P>
        ...
        approves or rejects each one &mdash; nothing is applied without that step.
      </P>
