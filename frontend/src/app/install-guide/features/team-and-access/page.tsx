...
export default function Page() {
  return (
    <>
      ...
      <P>
        <strong>Settings &rarr; Users &rarr; Add member.</strong> Enter an email and send &mdash; PurveX emails an
      ...
      <P>Four fixed roles &mdash; there&apos;s no custom role builder today.</P>
      <Table
        head={["Role", "Can do"]}
        rows={[
      ...
      <P>
        ...
        and when &mdash; searchable, filterable by action or resource type, and exportable as CSV. An admin can
        also set a minimum retention window and purge anything older.
      </P>

      <H2 id="one-org-per-account">One organization per account</H2>
      <P>
        Each PurveX login belongs to exactly one organization &mdash; there&apos;s no switcher. If someone genuinely
