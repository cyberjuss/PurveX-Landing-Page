...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "You may submit privacy requests through the methods designated by PurveX, including email at justinduru@purvex.io and, where made available, account, web, or support-channel request workflows. PurveX may take reasonable steps to verify identity and request authority before acting on a request.",
  ...
  },
  {
    title: "14. Contact",
    paragraphs: [
      "For privacy-related questions or requests, contact PurveX at justinduru@purvex.io or through the business contact information provided in your order form, master services agreement, or customer support channel.",
    ],
  },
];
