...
.ab-creds { margin-top: 20px; background: #fff; border: 1px solid var(--border-strong); border-left: 4px solid var(--accent); box-shadow: 0 24px 48px -38px rgba(42,34,128,.45) }
