...
.dc-eyebrow { margin: 0 0 12px; font-family: var(--font-mono); font-size: .66rem; font-weight: 700; letter-spacing: .16em; text-transform: uppercase; color: var(--accent-deep) }
.dc-h1 { margin: 0 0 14px; font-family: var(--font-display); font-size: clamp(1.9rem, 3.8vw, 2.6rem); font-weight: 600; line-height: 1.08; letter-spacing: -.04em; color: var(--ink) }
...
.dc-meta span { display: inline-flex; align-items: center; gap: 6px; font-family: var(--font-mono); font-size: .64rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: var(--muted-dim) }

.dc-h2 { font-family: var(--font-display); font-size: 1.35rem; font-weight: 600; letter-spacing: -.03em; color: var(--ink); margin: 40px 0 14px; scroll-margin-top: 76px }
...
.dc-step__num { width: 26px; height: 26px; border-radius: 5px; background: var(--accent-deep); color: #fff; display: flex; align-items: center; justify-content: center; font-family: var(--font-mono); font-size: .74rem; font-weight: 700 }
.dc-step__line { flex: 1; width: 1px; background: var(--border-strong); margin: 4px 0 }
.dc-step__body { flex: 1; padding-bottom: 26px }
.dc-step__body h3 { margin: 0 0 8px; font-family: var(--font-display); font-size: 1.05rem; font-weight: 600; letter-spacing: -.02em; color: var(--ink) }

.dc-term { border-radius: 6px; overflow: hidden; border: 1px solid var(--border-strong); box-shadow: 0 16px 36px -24px rgba(16,25,46,.32); margin: 10px 0 14px }
...
.dc-callout { border-radius: 0; border-left: 2px solid var(--accent-deep); padding: 13px 16px; font-size: .85rem; line-height: 1.65; margin: 4px 0 18px }
.dc-callout--warn { background: #fffbeb; border-left-color: #c4820e; color: var(--ink-soft) }
...
.dc-table th { text-align: left; font-family: var(--font-mono); font-size: .62rem; text-transform: uppercase; letter-spacing: .16em; color: var(--muted-dim); font-weight: 700; padding: 0 12px 8px 0; border-bottom: 1px solid var(--ink) }
...
.dc-label { font-family: var(--font-mono); font-size: .62rem; font-weight: 700; text-transform: uppercase; letter-spacing: .16em; color: var(--muted-dim); margin: 0 0 6px }
...
.dc-faq__q { margin: 0 0 6px; font-family: var(--font-display); font-weight: 600; font-size: 1.02rem; letter-spacing: -.02em; color: var(--ink) }
.dc-faq__a { margin: 0; font-size: .88rem; line-height: 1.65; color: var(--muted) }

.dc-role { border: 1px solid var(--border); border-top: 2px solid var(--ink); border-radius: 0; padding: 16px 18px; margin: 0 0 14px }
.dc-role__name { margin: 0 0 10px; font-weight: 700; font-size: .92rem; color: var(--ink) }
.dc-role__label { margin: 0 0 4px; font-family: var(--font-mono); font-size: .62rem; font-weight: 700; text-transform: uppercase; letter-spacing: .16em }
...
.dc-card { display: flex; flex-direction: column; gap: 4px; border: 1px solid var(--border); border-radius: 0; padding: 16px 18px; text-decoration: none; transition: border-color .15s, background .15s }
.dc-card:hover { border-color: var(--accent-deep); background: var(--surface-alt) }
.dc-card .t { font-family: var(--font-display); font-size: 1rem; font-weight: 600; letter-spacing: -.02em; color: var(--ink) }
