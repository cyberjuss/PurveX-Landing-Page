...
### Your First Day at GovTechFinancial
...
Each flag follows the format `FLAG{...}`. No login, no submission, no leaderboard, this is entirely for you to confirm you can actually navigate the environment, not just recite facts about it.
...
<p><code>FLAG{ou-users-financeaccounting-finance-accounting-users}</code></p>
...
<details class="ad-flag">
<summary>Reveal flag</summary>
<p><code>FLAG{alex-rivera-it-admins}</code></p>
...
<details class="ad-flag">
<summary>Reveal flag</summary>
<p><code>FLAG{accesslevels}</code></p>
...
<details class="ad-flag">
<summary>Reveal flag</summary>
<p><code>FLAG{no-gpo-no-delegation}</code></p>
...
<details class="ad-flag">
<summary>Reveal flag</summary>
<p><code>FLAG{dedicated-ou-prefix-never-expires}</code></p>
...
<details class="ad-flag">
<summary>Reveal flag</summary>
<p><code>FLAG{wrong-department-wrong-hours-critical-data}</code></p>
<ul>
