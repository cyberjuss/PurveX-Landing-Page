...
<p>Use Active Directory Users and Computers in your lab. Each task asks for a short answer, such as a group name, a person, or a number. Case, spaces, dots, and dashes do not matter. You get one hint and three tries per task, then the explanation unlocks. Nothing is submitted or stored.</p>
</div>
