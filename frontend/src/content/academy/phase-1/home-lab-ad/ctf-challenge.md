...
<p>Use the <strong>Find</strong> dialog to locate <code>jordan.ellis</code>, then open the <strong>Member Of</strong> tab. Which department group is he in?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">Right-click the domain, choose Find, and search for Jordan. Ignore Domain Users, which everyone has.</p></div>
<div class="ad-guess">
...
<p>Open the <code>IT Admins</code> group and read its <strong>Members</strong> tab. Who is in it?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">The group lives in the IT department OU. It has only one member.</p></div>
<div class="ad-guess">
...
<p>Expand the domain root. One default folder sits beside your OUs, and Group Policy cannot be linked to it. What is it called, exactly as AD writes it?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">Its name starts with CN=, not OU=. New accounts land here if nobody chooses an OU.</p></div>
<div class="ad-guess">
...
<p>Open the <code>IT Admins</code> group, go to <strong>Properties</strong>, and read the Description. Which role is it meant for? Use dashes between words.</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">The Description is on the General tab. It names a job title in the plural.</p></div>
<div class="ad-guess">
...
<p>Priya Nair's title is "Help Desk Technician." Open the <code>Helpdesk</code> group and read its <strong>Members</strong> tab. Is Priya in it? Type <code>yes</code> or <code>no</code>.</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">Check the group's member list. Do not go by her title.</p></div>
<div class="ad-guess">
...
<p>Search your lab for the user whose title is <strong>Settlements Coordinator</strong>. Who is it?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">In Find, use the Advanced tab with the Title field. You can also open the Operations users one by one.</p></div>
<div class="ad-guess">
<input type="text" class="ad-guess__input" placeholder="first and last name" autocomplete="off" autocapitalize="off" spellcheck="false">
...
<p>Open the IT department's <code>Workstations</code> OU. What is the exact name of the computer object in it?</p>
...
<p>Open the <code>Compliance Users</code> group. How many members does it have?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">Read the Members tab of the group, or run <code>(Get-ADGroupMember "Compliance Users").Count</code>.</p></div>
<div class="ad-guess">
...
<p>Expand <code>Departments</code> in your lab. How many department OUs sit directly under it?</p>
<div class="ad-hint"><button type="button" class="ad-hint__btn">Get a hint</button><p class="ad-hint__text">Count only the OUs one level down. Do not count the Users or Workstations OUs inside them.</p></div>
<div class="ad-guess">
<input type="text" class="ad-guess__input" placeholder="a number" autocomplete="off" autocapitalize="off" spellcheck="false">
