...
<p class="ad-hint__text">Open the group in your lab and read its Members tab. There are 9 people in the directory, so work out who is missing by comparing the list with the User Directory.<br><br>PowerShell option: <code>(Get-ADGroupMember "All Employees").Count</code></p>
...
<p class="ad-hint__text">Open her account in your lab and check the Account tab. An unlock option only appears when an account is actually locked. Also look at the option about changing the password at next logon.<br><br>PowerShell option: <code>Get-ADUser riley.kwan -Properties LockedOut, PasswordExpired | Select Name, LockedOut, PasswordExpired</code></p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Open the group in your lab and read its Members tab. Alex, Priya, and Casey are IT staff. If the number is higher than you expect, find who does not belong.<br><br>PowerShell option: <code>(Get-ADGroupMember "IT Users").Count</code></p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Open the account's Properties in your lab and read its Description. It ends with the expected hours in 24-hour time.<br><br>PowerShell option: <code>(Get-ADUser svc-backup-job -Properties Description).Description</code></p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Find the account in your lab and read the OU path above it. Count only the parts that start with OU=. Ignore CN= and the DC= parts at the end.<br><br>PowerShell option: <code>(Get-ADUser taylor.osei).DistinguishedName</code></p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Find the computer in your lab, open its Properties, and read the Description. The ID is at the start, before the colon.<br><br>PowerShell option: <code>(Get-ADComputer WM-WKS07 -Properties Description).Description</code></p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Count only the 4625 rows above the first 4624. Ignore the later success.</p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
<p class="ad-flag__code"><code>GTF{4}</code></p>
...
<p class="ad-hint__text">Open Alex's account in your lab and read the Member Of tab. It is the second group he holds, the one nobody else has.</p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Look at the gap between attempts, the hour, and whether an IT admin normally works from a Wealth Management machine.</p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
...
<p class="ad-hint__text">Stop the spread first, and keep the evidence you will need afterward.</p>
<p class="ad-guess__feedback"></p>
<div class="ad-flag">
<span class="ad-flag__label">Finding</span>
<p class="ad-flag__code"><code>GTF{b}</code></p>
