...
For the host(s) you couldn't rule out as ordinary Windows traffic:
...
11. This request appears **twice** in the capture, at two different times. What's different about the parameter value between the two occurrences? What might that difference represent?
