...
Think of it like reading someone's mail log. You can't see inside a sealed envelope, but you can see who wrote to whom and how often. If a letter wasn't sealed (encrypted), you can sometimes read it too.
...
Type these one at a time. Try each, and look at what changes:
