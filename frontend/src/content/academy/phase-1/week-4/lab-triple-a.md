...
**4\. Look at the "My Account" page requests**  
 Notice it only sends your session cookie. There's nothing you can tamper with there. Not the vulnerable spot.
...
**7\. Add `roleid=2` to your request yourself**  
 The original request didn't include `roleid`. Try adding it manually:
