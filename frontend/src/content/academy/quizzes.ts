    ...
    questions: [
      {
        ...
        correctIndex: 2,
        explanation: "Availability means authorized users can reach systems and data when they need to. Knocking a server offline doesn't expose or alter data. It just makes the data unreachable, which is an availability failure.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "Follow → HTTP Stream reassembles the full conversation into something readable. It's the single most useful move once you've narrowed in on a suspicious host.",
      },
      {
        ...
        options: [
          "It isn't, since GET-based exfil is harder to detect than POST",
        ...
        correctIndex: 2,
        explanation: "Because the data rides in the URL itself, it's visible in plaintext web/proxy logs and browser history. That makes it easier to find after the fact than a POST body would be, a small silver lining in an otherwise bad situation.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation: "The app let the client dictate its own privilege level (`roleid=2`) instead of the server enforcing it. That's a textbook broken access control flaw. Trusting client-supplied state for an authorization decision is exactly what a server should never do.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "It doesn't, since every account is equally likely to be compromised",
        ...
        correctIndex: 1,
        explanation: "Alex sits in both IT Users and IT Admins. That's the only account with elevated access alongside standard access. Knowing who holds broader privilege ahead of time is exactly the kind of baseline knowledge that makes an alert on that account easier to weigh correctly.",
      },
    ],
  },
];
